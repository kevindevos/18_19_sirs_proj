...
%JAVACMD% %JAVA_OPTS%  -classpath %CLASSPATH% -Dapp.name="kerby-ws-cli" -Dapp.repo="%REPO%" -Dapp.home="%BASEDIR%" -Dbasedir="%BASEDIR%" pt.ulisboa.tecnico.sdis.kerby.cli.KerbyClientApp %CMD_LINE_ARGS%
