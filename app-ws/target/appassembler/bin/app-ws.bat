...
%JAVACMD% %JAVA_OPTS%  -classpath %CLASSPATH% -Dapp.name="app-ws" -Dapp.repo="%REPO%" -Dapp.home="%BASEDIR%" -Dbasedir="%BASEDIR%" sirs.app.ws.App %CMD_LINE_ARGS%
